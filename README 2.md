...
<a href="https://github.com/lorenzkahl/lorenzkahl.de/generate">
...
<details>
<summary>2. Run the "Remove lorenzkahl.de branding" action</summary>

1. Click the "Actions" tab in the top navigation of your repository
2. Click the "Remove lorenzkahl.de branding" workflow
...
Start your project with lorenzkahl.de by clicking the "Use this template" button below:
...
Deploy your lorenzkahl.de site for **free** with GitHub Pages:
...
Deploy lorenzkahl.de to [Netlify](https://netlify.com) for **free**!
...
Deploy lorenzkahl.de to [Cloudflare Pages](https://pages.cloudflare.com/) for global edge performance:
...
lorenzkahl.de includes additional features that are disabled by default. Enable them when you need them:
...
```text
example.com                 # → Root of your lorenzkahl.de project
...
├── README.lorenzkahl.de.md     # → Template documentation
