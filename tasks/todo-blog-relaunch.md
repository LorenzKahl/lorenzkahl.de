...
Plan: [`tasks/plan-blog-relaunch.md`](plan-blog-relaunch.md) · Spec: [`docs/spec/blog-relaunch.md`](../docs/spec/blog-relaunch.md)

> Archived: this round shipped and merged (PR #2). Superseded as the
> active plan by [`tasks/plan.md`](plan.md) / [`tasks/todo.md`](todo.md).
