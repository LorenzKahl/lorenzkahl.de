...
🪐 Or edit your entire site in a web-based editor by [clicking here](https://github.dev/lorenzkahl/lorenzkahl.de/).
...
#### Posts
Blog posts
* [Create a new post](https://github.com/lorenzkahl/lorenzkahl.de/new/main/?filename=/src/content/posts/&value=----%0Atitle%3A%20%22Enter%20post%20title%22%0Adate%3A%20%222025-01-01%0A---)
...
<details>
  <summary><strong>🚀 Deploy lorenzkahl.de</strong></summary>

## Deploy lorenzkahl.de
...
1. [Enable GitHub Pages](https://github.com/lorenzkahl/lorenzkahl.de/settings/pages) in your repository settings, choose "GitHub Actions" as the source.
2. [Allow "Read and write permissions" for GitHub Workflows](https://github.com/lorenzkahl/lorenzkahl.de/settings/actions) in your repository settings for the GitHub Actions workflow to run.
...
## Get to Know lorenzkahl.de

Ready to go deeper? Here's how lorenzkahl.de is laid out:
...
├── README.lorenzkahl.de.md     # → Template repository readme
└── README.md
```
